      ...
      <div className={styles.Penguins}>
        ...
        <a onClick={() => setS(1)}>
          ...
          {s == 1 ? (
            <div
              ...
              style={{ marginLeft: "205px", marginTop: "35px" }}
            >
        ...
        <a onClick={() => setS(2)}>
          ...
          {s == 2 ? (
            <div
              className={styles.Info}
              style={{ marginLeft: "132px", marginTop: "15px" }}
            >
              <div className={styles.Line} style={{ width: "120px" }}></div>
              <div
                className={styles.SecondLineLeft}
                style={{ top: "170px", left: "57px" }}
              ></div>
              <div
                className={styles.CircleLeft}
                style={{ top: "168px", left: "55px" }}
              ></div>
              <h2
                className={styles.PersonLeft}
                style={{ top: "140px", left: "48px" }}
              >
                Ale
              </h2>
              <h3
                className={styles.JobLeft}
                style={{ top: "170px", left: "42px" }}
              >
                BARRENDERO
              </h3>
            </div>
        ...
        <a onClick={() => setS(3)}>
          ...
          {s == 3 ? (
            <div
              className={styles.Info}
              style={{ marginLeft: "135px", marginTop: "45px" }}
            >
              <div className={styles.Line}></div>
              <div className={styles.SecondLineLeft}></div>
              <div className={styles.CircleLeft}></div>
              <h2 className={styles.PersonLeft} style={{ left: "5px" }}>
                Flor
              </h2>
          ...
          {s == 4 ? (
            ...
            >
              ...
              <div
                ...
                style={{ top: "166px", left: "61px" }}
              ></div>
              <div
                className={styles.Circle}
                style={{ top: "165px", left: "70px" }}
              ></div>
              <h2
                className={styles.Person}
                style={{ top: "138px", left: "80px" }}
              >
                Penguin
              </h2>
              <h3 className={styles.Job} style={{ top: "169px", left: "76px" }}>
                GERENTE EN UN ZOO
              </h3>
            </div>
          ) : (
        ...
        <a onClick={() => setS(5)}>
          ...
          {s == 5 ? (
            ...
            >
              ...
              <div
                className={styles.SecondLine}
                style={{ top: "176px", left: "70px" }}
              ></div>
              <div
                className={styles.Circle}
                style={{ top: "175px", left: "80px" }}
              ></div>
              <h2
                className={styles.Person}
                style={{ top: "148px", left: "90px" }}
              >
                Mati
              </h2>
              <h3 className={styles.Job} style={{ top: "178px", left: "70px" }}>
                PROFE DE PADEL
              </h3>
            </div>
          ) : (
        ...
        <a onClick={() => setS(6)}>
          ...
          {s == 6 ? (
            ...
            >
              ...
              <h3 className={styles.Job} style={{ left: "38px" }}>
                CORREDORA DE BOLSA
              </h3>
            </div>
          ) : null}
        ...
        <a onClick={() => setS(7)}>
          ...
          {s == 7 ? (
            ...
            >
              ...
              <h3 className={styles.Job} style={{ left: "38px" }}>
                DOBLE DEL DOBLE DE BRUCE WILLIS
              </h3>
            </div>
          ) : (
            ""
